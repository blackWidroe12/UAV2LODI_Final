...
export function HangarPage({ onOpenProject }: HangarPageProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="h-14 border-b border-border/50 glass-subtle flex items-center justify-between px-6">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary to-accent flex items-center justify-center">
            <Layers className="w-4 h-4 text-primary-foreground" />
          </div>
          <span className="font-display font-semibold">UAV2LoD1-ZW</span>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        >
          ...
          {!isLoading && !error && filteredProjects.length === 0 && !searchQuery && (
            <div className="text-center py-12 glass rounded-xl mt-4">
